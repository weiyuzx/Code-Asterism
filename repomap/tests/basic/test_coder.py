...
from repomap.coders.base_coder import FinishReasonLength, UnknownEditFormat
from repomap.dump import dump  # noqa: F401
from repomap.io import InputOutput
from repomap.models import Model
from repomap.repo import GitRepo
from repomap.sendchat import sanity_check_messages
from repomap.utils import GitTemporaryDirectory
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("aider.coders.architect_coder.AskCoder.__init__", return_value=None):
                from repomap.coders.architect_coder import ArchitectCoder
